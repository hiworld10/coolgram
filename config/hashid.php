...
return [
    ...
    */
    ...
    'default' => env('HASHID_CONNECTION', 'hashids_coolgram'),
    ...
    */
    ...
    'connections' => [
        ...
        // Custom connection for this application.
        'hashids_coolgram' => [
            'driver' => 'hashids',
            'salt' => env('HASHIDS_SALT', 'coolgram-salt-for-post-ids'),
            'min_length' => env('HASHIDS_MIN_LENGTH', 11),
            // Underscores and hyphens are added, as these are also included 
            // in hashed ids in sites like yt or ig.
            'alphabet' => env('HASHIDS_ALPHABET', 'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890-_'),
        ],        
